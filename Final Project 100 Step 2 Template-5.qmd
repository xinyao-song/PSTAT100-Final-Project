...
#We create side by side density histograms based on relationship status to show free time distribution
...
#We create density plot with romantic as a factor to overlay the two density plots
