...
por_df <- read_csv("/Users/nicholaschan/Desktop/PSTAT100/Final\ Project/student-por.csv")
...
Question 3 Romantic Relationship -> Free Time
There is a significant difference in means in free time between students in a relationship and those who are not.
```{r}
